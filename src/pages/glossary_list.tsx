...
export const GlossaryList = () => {
  ...
  const getItem = (g: Types.Glossary) => {
    return <Collapse.Panel key={g.glossaryId} header={g.name} style={{fontWeight: 600, overflowWrap: 'break-word', paddingTop: 0, paddingBottom: 0}}>
      <div style={{fontWeight: 400, padding: 20, textAlign:'left',fontSize: 14,overflowWrap: 'break-word'}}>{g.body}</div>
    </Collapse.Panel>
  }
